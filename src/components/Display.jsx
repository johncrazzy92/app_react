...
function Display({close,switch: displayMenu}) {

  return (
    <div className={`lg:w-3/12 w-full bg-gradient-to-t from-orange-500 to-orange-600 h-screen  flex-col absolute left-0 ${close? 'block' : 'hidden'} z-20 gap-5 px-4 py-5`}>
        <div className='flex justify-between text-white '>
            <p className='cursor-pointer'>Account</p>
            <img className='cursor-pointer' onClick={displayMenu} src={cross} alt="close menu" />
        </div>
